...
const RideCard = ({ride: {origin_longitude, origin_latitude, destination_longitude, destination_latitude, driver, origin_address, destination_address, ride_time, fare_price, created_at, payment_status}}:{ride: Ride}) => {
  return (
